...
class ProviderSpec:
    ...
    # This selection owns reasoning and tools. Failure must remain visible;
    # neither the router nor a vision/tool helper may substitute another model.
    exclusive_main_brain: bool = False
...
PROVIDERS: tuple[ProviderSpec, ...] = (
    ...
    ProviderSpec(
        ...
        exclusive_main_brain=True,
        signup_url="https://chatgpt.com",
        credential_help=(
            "Main assistant through your existing Codex ChatGPT login. "
            "Jarvis supplies shared memory and executes its tools. No model API key."
        ),
        experimental=True,
    ),
    ProviderSpec(
