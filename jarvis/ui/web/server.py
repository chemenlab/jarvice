...
class WebServer:
    ...
    def _build_app(self) -> FastAPI:
        ...
        from .main_brain_routes import router as main_brain_router
        ...
        app.include_router(main_brain_router)
    ...
    def _init_session_stack(self) -> None:
        ...
        # data/sessions.db, indefinite text retention). Explicit pruning is opt-in.
        section = self._read_sessions_toml_section()
