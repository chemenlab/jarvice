...
// Connection probing has its own component suite; this suite owns voice tabs.
vi.mock("@/components/providers/MainBrainStatusCard", () => ({
  MainBrainStatusCard: () => null,
}));
...
describe("ApiKeysView two-mode", () => {
  ...
  it("keeps the main Brain choice visible while switching the voice to Realtime", () => {
    render(<ApiKeysView />);
