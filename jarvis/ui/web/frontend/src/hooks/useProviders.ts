...
export async function switchBrainProvider(providerId: string): Promise<BrainSwitchResult> {
  ...
  return {
    requires_restart: body.requires_restart === true,
    applied_live: body.applied_live ?? body.requires_restart !== true,
    new_provider: body.new_provider ?? body.active ?? providerId,
  };
}
