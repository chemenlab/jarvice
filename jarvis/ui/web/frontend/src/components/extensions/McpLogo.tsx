...
/**
 * The Model Context Protocol mark, inlined so the navigation never depends on
 * a CDN being reachable. Glyph from Simple Icons (CC0); drawn in
 * `currentColor` so it follows the text colour of the row it sits in, exactly
 * like the Lucide icons next to it.
 */
