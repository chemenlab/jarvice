...
# module needs no heavy import; supported app languages are en/de/es/ru.
_DEFAULT_LANG = "en"
...
VOSK_MODELS: dict[str, VoskModelSpec] = {
    # Downloaded from the official model catalog and pinned 2026-09-13.
    "ru": VoskModelSpec(
...
def _models_root(data_dir: str | None) -> Path:
    ...
    base = (data_dir or os.environ.get("JARVIS__MEMORY__DATA_DIR")
            or os.environ.get("JARVIS_DATA_DIR") or "data")
