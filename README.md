> **chemenlab/jarvice fork:** For this Russian assistant with Codex subscription
> reasoning, use the [installation guide for this fork](docs/INSTALL-RUSSIAN-ASSISTANT.md).
> The upstream release installers documented below do not contain these changes.
